...
$summary =~ s!\QCurrent apply script differs from 'https://raw.githubusercontent.com/CHECK-SPELLING/CHECK-SPELLING/[^']+?/apply.pl' (locally downloaded to ...). You may wish to upgrade.\E\n!!;
